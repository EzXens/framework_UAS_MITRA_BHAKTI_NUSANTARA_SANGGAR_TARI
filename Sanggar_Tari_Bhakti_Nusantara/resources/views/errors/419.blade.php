...
@section('content')
    <section class="flex min-h-[85vh] items-center justify-center bg-[#F5F5F4] py-24">
        <div class="mx-auto max-w-xl text-center">
            ...
            <h1 class="text-4xl font-semibold text-black">419 · Sesi Berakhir</h1>
            <p class="mt-3 text-sm text-black-400">Permintaan Anda kedaluwarsa. Muat ulang halaman dan coba lagi untuk melanjutkan proses.</p>
