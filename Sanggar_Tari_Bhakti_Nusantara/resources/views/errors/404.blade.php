...
@section('content')
    <section class="flex min-h-[85vh] items-center justify-center bg-[#F5F5F4] py-24">
        <div class="mx-auto max-w-xl text-center">
            ...
            <h1 class="text-4xl font-semibold text-black">404 · Halaman Tidak Ditemukan</h1>
            <p class="mt-3 text-sm text-black-400">Kami tidak dapat menemukan halaman yang Anda cari. Periksa kembali alamat URL.</p>
