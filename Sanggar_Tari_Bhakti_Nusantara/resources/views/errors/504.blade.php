...
@section('content')
    <section class="flex min-h-[85vh] items-center justify-center bg-[#F5F5F4] py-24">
        <div class="mx-auto max-w-xl text-center">
            ...
            <h1 class="text-4xl font-semibold text-black">504 · Gateway Timeout</h1>
            <p class="mt-3 text-sm text-black-400">Permintaan memerlukan waktu terlalu lama. Silakan refresh atau coba lagi beberapa saat.</p>
