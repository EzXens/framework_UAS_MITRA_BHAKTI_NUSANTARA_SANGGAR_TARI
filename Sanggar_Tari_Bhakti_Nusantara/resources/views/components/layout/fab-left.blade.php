<div style="position: fixed; bottom: 20px; left: 20px; z-index: 1000;">
  <button title="Melihat Ulang Tutorial" class="btn btn-circle btn-xl" onclick="openTutorialResetModal()">
  ...
  <div class="bg-black/70 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
    <div class="text-center">
      ...
      <p class="text-sm text-white mb-6">
        Apakah Anda ingin Melihat Ulang semua tutorial? Ini Akan Memulai Ulang Tutorial Dari Awal.
      </p>
