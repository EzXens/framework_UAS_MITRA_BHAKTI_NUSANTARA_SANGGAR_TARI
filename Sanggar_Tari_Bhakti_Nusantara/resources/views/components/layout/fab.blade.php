<div class="fab fab-flower" style="bottom: 20px; right: 20px;">
  <!-- a focusable div with tabindex is necessary to work on all browsers. role="button" is necessary for accessibility -->
  <div tabindex="0" role="button" class="btn btn-circle btn-xl">
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16"><path fill="#FFFFFF" d="M12.2 10c-1.1-.1-1.7 1.4-2.5 1.8C8.4 12.5 6 10 6 10S3.5 7.6 4.1 6.3c.5-.8 2-1.4 1.9-2.5c-.1-1-2.3-4.6-3.4-3.6C.2 2.4 0 3.3 0 5.1c-.1 3.1 3.9 7 3.9 7c.4.4 3.9 4 7 3.9c1.8 0 2.7-.2 4.9-2.6c1-1.1-2.5-3.3-3.6-3.4z"/></svg>
  </div>

  <!-- Main Action button replaces the original button when FAB is open -->
  <button class="fab-main-action btn btn-circle btn-xl bg-[#FEDA60]">
 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 14 14"><path fill="#FFFFFF" fill-rule="evenodd" d="M8.052.86a.75.75 0 0 0-.75-.75a7.25 7.25 0 0 0-7.25 7.25a.75.75 0 1 0 1.5 0a5.75 5.75 0 0 1 5.75-5.75a.75.75 0 0 0 .75-.75m-1.074 12.6a2.7 2.7 0 0 1-3.37-.36l-.38-.38a.91.91 0 0 1 0-1.28l1.6-1.59a.9.9 0 0 1 1.27 0a.91.91 0 0 0 1.28 0l2.55-2.55a.91.91 0 0 0 0-1.28a.9.9 0 0 1 0-1.27l1.54-1.6a.91.91 0 0 1 1.28 0l.38.38a2.7 2.7 0 0 1 .41 3.37a24.23 24.23 0 0 1-6.56 6.56m.638-10.457a.75.75 0 0 1 0 1.5a3.25 3.25 0 0 0-3.25 3.25a.75.75 0 0 1-1.5 0a4.75 4.75 0 0 1 4.75-4.75" clip-rule="evenodd"/></svg>
  </button>

  <!-- buttons that show up when FAB is open -->
  {{-- whatsapp --}}
  <button onclick="openWhatsApp()" class="btn btn-circle btn-xl">
  ...
  {{-- Instagram --}}
  <button onclick="openInstagram()" class="btn btn-circle btn-xl">
  ...
  {{-- gmail --}}
  <button onclick="openGmail()" class="btn btn-circle btn-xl">
...
function openWhatsApp() {
    const phone = "628125818180";
    const message = 
`Halo admin Bhakti Nusantara,
...
function openInstagram() {
    ...
    const url = `https://www.instagram.com/bn_bhaktinusantara/`;
    window.open(url, "_blank");
}

function openGmail() {
    const to = "bhaktimahakam@gmail.com";
    const subject = encodeURIComponent("Hubungi Bhakti Nusantara");
    const body = encodeURIComponent(
`Halo admin Bhakti Nusantara,

Saya ingin menghubungi Anda mengenai...`
    );
