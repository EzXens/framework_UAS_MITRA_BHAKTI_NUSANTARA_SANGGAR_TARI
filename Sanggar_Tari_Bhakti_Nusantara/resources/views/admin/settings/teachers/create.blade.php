        ...
        <main class="flex-1 lg:ml-0 p-6 lg:p-10">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-8">
                    ...
                    <h1 class="text-3xl font-bold text-[#2E2E2E] mb-2">Tambah Pengajar Baru</h1>
                    <p class="text-[#4F4F4F]">Lengkapi informasi pengajar</p>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('position') }}"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#F5B347] focus:ring-2 focus:ring-[#F5B347]/20 outline-none transition-all text-gray-900 placeholder-gray-400"
                                    placeholder="Contoh: Instruktur Utama"
                                    required
                                >
                                @error('position')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#F5B347] focus:ring-2 focus:ring-[#F5B347]/20 outline-none transition-all text-gray-900 placeholder-gray-400"
                                    placeholder="Contoh: Tari Tradisional Jawa"
                                >
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    rows="4"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#F5B347] focus:ring-2 focus:ring-[#F5B347]/20 outline-none transition-all text-gray-900 placeholder-gray-400"
                                    placeholder="Tuliskan pengalaman, prestasi, atau latar belakang pengajar..."
                                >{{ old('bio') }}</textarea>
                                @error('bio')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                >
                                <p class="text-xs text-[#4F4F4F] mt-1">Format: JPG, PNG, WEBP. Maksimal 2MB. Disarankan ukuran 400x400px.</p>
                                @error('photo')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
