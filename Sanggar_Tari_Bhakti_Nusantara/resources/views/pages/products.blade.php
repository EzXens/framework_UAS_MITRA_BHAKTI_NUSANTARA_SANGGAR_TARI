        ...
        <div class="max-w-7xl mx-auto px-6 py-16 lg:py-14 space-y-12">
            ...
            <div class="grid gap-8 sm:grid-cols-2 xl:grid-cols-3">
                @forelse ($products as $product)
                    <article class="flex flex-col overflow-hidden rounded-[28px] border border-[#FEDA60]/30 bg-white shadow-lg shadow-[#FEDA60]/10 hover:shadow-xl hover:shadow-[#FEDA60]/20 transition-all hover:scale-[1.02]">
                        @if($product->image)
                            <div class="h-56 w-full overflow-hidden">
                                <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="w-full h-full object-cover">
                            </div>
                        @else
                            <div class="h-56 w-full bg-gradient-to-br from-[#FFE184] via-[#FEDA60] to-[#F5B347] flex items-center justify-center">
                        ...
                        <div class="flex flex-col gap-4 p-6 bg-white text-[#2E2E2E]">
                            ...
                            <p class="text-sm leading-relaxed text-[#4F4F4F] line-clamp-3">{{ $product->description }}</p>
                            <div class="flex items-center justify-between pt-2 border-t border-[#FEDA60]/30">
                            ...
                            <a href="mailto:info@bhaktinusantara.id?subject=Inquiry about {{ $product->name }}" class="inline-flex items-center justify-center gap-2 text-sm font-semibold text-white bg-gradient-to-r from-[#FEDA60] to-[#F5B347] px-6 py-3 rounded-xl shadow-lg shadow-[#FEDA60]/30 hover:shadow-xl hover:scale-[1.02] transition-all">
                                Hubungi Kami
