        ...
        <div class="mt-16 rounded-3xl bg-gradient-to-br from-[#2E2E2E] via-[#1a1a1a] to-[#2E2E2E] p-8 lg:p-12 border border-[#FEDA60]/20 shadow-2xl relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    <a href="https://wa.me/+628125818180" target="_blank" class="flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-[#FEDA60]/20 hover:bg-white/10 transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-[#FEDA60] font-semibold group-hover:text-white transition-colors">+62 812-581-8180</p>
                        </div>
                    </a>
                    ...
                    <a href="https://www.instagram.com/bn_bhaktinusantara/" target="_blank" class="flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-[#FEDA60]/20 hover:bg-white/10 transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-[#FEDA60] font-semibold group-hover:text-white transition-colors">@bn_bhaktinusantara</p>
                        </div>
                    </a>
                </div>
            </div>
