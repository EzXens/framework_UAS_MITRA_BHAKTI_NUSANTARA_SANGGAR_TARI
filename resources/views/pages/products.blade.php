...
@section('content')
    ...
    <section class="bg-[#2B2B2B] text-white">
        <div class="max-w-7xl mx-auto px-6 py-16 lg:py-24 space-y-12">
            <div class="space-y-4">
                ...
                <h1 class="text-3xl lg:text-5xl font-semibold">Koleksi Pilihan Bhakti Nusantara</h1>
                <p class="max-w-2xl text-sm lg:text-base text-white/70 leading-relaxed">Eksplorasi paket pentas, kostum, serta materi pembelajaran terkurasi untuk mendukung pengalaman seni tari yang lebih berkesan.</p>
            </div>
