...
@section('content')
    {{-- <section class="relative overflow-hidden bg-gradient-to-br from-white via-[#FFF6D5] to-[#FEDA60]/30"> --}}
    <section class="relative overflow-hidden bg-[#2E2E2E]">
        <div class="max-w-7xl mx-auto px-6 py-16 lg:py-24 grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div class="space-y-6">
                <span class="inline-flex px-4 py-1 rounded-full bg-[#FFF0C2] text-[#8C6A08] text-xs font-semibold uppercase tracking-[0.2em]">Sanggar Tari</span>
                <h1 class="text-3xl lg:text-5xl font-semibold text-[#E2B136] leading-tight">
                    Bhakti Nusantara<br class="hidden lg:block"> Ruang Ekspresi Tari Tradisional Indonesia
                </h1>
                <p class="text-sm lg:text-base text-[#E2B136] max-w-xl leading-relaxed">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('products') }}" class="px-6 py-3 rounded-full bg-[#FEDA60] text-black text-sm font-semibold shadow-lg shadow-[#FEDA60]/40">Daftar</a>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 lg:py-24 grid gap-12 lg:grid-cols-[0.9fr_1.1fr] items-center" id="tentang">
        <div class="relative">
            ...
            <div class="relative rounded-[32px] border border-[#FEDA60]/60 bg-white shadow-xl overflow-hidden p-8 space-y-6">
                ...
                <div class="relative grid gap-4">
                    <div class="rounded-3xl bg-gradient-to-br from-[#FFE89F] via-[#F9CE63] to-[#F6B643] p-6 text-[#E2B136] shadow-lg">
                        ...
                        <p class="text-xl font-semibold mt-2">Ruang Tari Bhakti Nusantara</p>
                        <p class="text-sm text-[#E2B136] leading-relaxed opacity-90 mt-3">Studio berlantai kayu, cermin panorama, dan sistem audio profesional untuk mendukung latihan intensif.</p>
                    </div>
                    <div class="grid gap-4 sm:grid-cols-2">
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 lg:py-24 space-y-10" id="jadwal">
        @include('components.ui.section-heading', [
    ...
    <section class="max-w-5xl mx-auto px-6 pb-20">
        <div class="rounded-[32px] bg-[#2E2E2E] text-white px-8 py-12 lg:px-16 lg:py-16 flex flex-col lg:flex-row items-start lg:items-center gap-8">
            <div class="space-y-3">
                <h2 class="text-2xl lg:text-4xl font-semibold">Siap Bergabung dengan Bhakti Nusantara?</h2>
                <p class="text-sm lg:text-base text-white/80 leading-relaxed">Daftarkan diri Anda untuk sesi trial gratis dan rasakan atmosfer latihan di studio kami. Tim kami siap membantu menentukan kelas terbaik.</p>
            </div>
            <a href="mailto:info@bhaktinusantara.id" class="px-6 py-3 rounded-full bg-[#FEDA60] text-[#E2B136] text-sm font-semibold">Booking Trial</a>
        </div>
    </section>
@endsection
